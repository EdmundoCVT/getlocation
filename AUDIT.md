...
3. La fonction recalcule tout : durée en heures → jours facturables (même formule que `joursFacturablesDepuisHeures`), tarif × jours, + assurance si cochée (8 €/jour, valeur serveur elle aussi), impose `currency: "eur"`, rejette `vehiculeId` inconnu, rejette dates passées/invalides, borne la longueur des chaînes.
