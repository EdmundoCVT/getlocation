// src/lib/validate-reservation-input.js
//
...
//
// Copie fonctionnellement identique à l'ancienne
// netlify/functions/lib/validate-reservation-input.js (Phase A), déplacée
// ici pour le Worker Cloudflare (Phase B, voir DEPLOIEMENT.md). La version
// netlify/ est conservée telle quelle tant que la bascule n'est pas
...
function validateReservationInput(payload) {
  ...
  // Case CGL/confidentialité obligatoire avant paiement : on exige
