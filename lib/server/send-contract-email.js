...
// TextEncoder + btoa (Web-standard) plutôt que Buffer.from (API Node
// "legacy") : produit exactement les mêmes octets base64, mais fonctionne
// aussi en Cloudflare Workers — voir plan de migration Cloudflare, B.2.
